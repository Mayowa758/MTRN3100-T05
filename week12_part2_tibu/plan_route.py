...
def show_course_result(planning_image, obstacle_count: int, motion_count: int) -> None:
    ...
    messagebox.showinfo(
        ...
        f"Obstacle-course motions: {motion_count}\n\n"
...
def main() -> int:
    ...
    if gui_launch:
        show_course_result(planning_image, len(result.obstacles), len(result.motions))
    return 0
